...
if __name__ == '__main__':
    ...
    model = MCSRNet(scale_factor=args.scale,num_channels=args.num_channels,num_features=args.num_features,growth_rate=args.growth_rate,num_layers=args.num_layers,B=args.B, U=args.U).to(device)
...
##############################################            
    ...
    output.save(args.image_file.replace('.', '_RDCAB-RecursiveSRNet_x{}.'.format(args.scale)))
